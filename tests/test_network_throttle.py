...
def test_network_throttle_waits_before_first_and_queues_following_requests():
    ...
    # First wait: delay=10.0+5.0*0.0=10.0, accumulated 10.0
    # Second wait: delay=10.0+5.0*0.0=10.0, accumulated 20.0 (queued behind first)
...
async def test_network_throttle_async_wait_uses_async_sleep():
    ...
    # delay = base_delay (10.0) + jitter (5.0) * random (1.0) = 15.0
    async_sleep.assert_awaited_once_with(15.0)
